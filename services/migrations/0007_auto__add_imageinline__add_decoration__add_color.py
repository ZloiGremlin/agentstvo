...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ImageInline'
        db.create_table(u'services_imageinline', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100)),
            ('color', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['services.Color'], max_length=255)),
            ('decoration', self.gf('django.db.models.fields.related.ForeignKey')(related_name='images', max_length=255, to=orm['services.Decoration'])),
            ('sort', self.gf('django.db.models.fields.IntegerField')(default=100)),
        ))
        db.send_create_signal(u'services', ['ImageInline'])

        # Adding model 'Decoration'
        db.create_table(u'services_decoration', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'services', ['Decoration'])

        # Adding model 'Color'
        db.create_table(u'services_color', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('rgb', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'services', ['Color'])


    def backwards(self, orm):
        # Deleting model 'ImageInline'
        db.delete_table(u'services_imageinline')

        # Deleting model 'Decoration'
        db.delete_table(u'services_decoration')

        # Deleting model 'Color'
        db.delete_table(u'services_color')
    ...
    models = {
        ...
        u'services.imageinline': {
            ...
            'color': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['services.Color']", 'max_length': '255'}),
