...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Service.page'
        db.add_column(u'services_service', 'page',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cms.Page']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Service.page'
        db.delete_column(u'services_service', 'page_id')
