...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CategoryCake'
        db.create_table(u'services_categorycake', (
        ...
        db.send_create_signal(u'services', ['CategoryCake'])

        # Adding field 'Cake.category'
        db.add_column(u'services_cake', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['services.CategoryCake'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CategoryCake'
        db.delete_table(u'services_categorycake')

        # Deleting field 'Cake.category'
        db.delete_column(u'services_cake', 'category_id')
