...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'services_service', (
            ...
            ('teaser', self.gf('django.db.models.fields.TextField')(max_length=255)),
        ...
        db.send_create_signal(u'services', ['ServicePlugin'])

        # Adding M2M table for field service on 'ServicePlugin'
        db.create_table(u'services_serviceplugin_service', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('serviceplugin', models.ForeignKey(orm[u'services.serviceplugin'], null=False)),
            ('service', models.ForeignKey(orm[u'services.service'], null=False))
        ))
        db.create_unique(u'services_serviceplugin_service', ['serviceplugin_id', 'service_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field service on 'ServicePlugin'
        db.delete_table('services_serviceplugin_service')
