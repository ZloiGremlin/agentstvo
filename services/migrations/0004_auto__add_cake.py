...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Cake'
        db.create_table(u'services_cake', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('weight', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.send_create_signal(u'services', ['Cake'])


    def backwards(self, orm):
        # Deleting model 'Cake'
        db.delete_table(u'services_cake')
    ...
    models = {
        ...
        u'services.cake': {
            ...
            'weight': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        u'services.service': {
