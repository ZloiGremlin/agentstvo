...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Requisite'
        db.create_table(u'services_requisite', (
        ...
        db.send_create_signal(u'services', ['Requisite'])

        # Adding M2M table for field color on 'Requisite'
        db.create_table(u'services_requisite_color', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('requisite', models.ForeignKey(orm[u'services.requisite'], null=False)),
            ('color', models.ForeignKey(orm[u'services.color'], null=False))
        ))
        db.create_unique(u'services_requisite_color', ['requisite_id', 'color_id'])

        # Adding model 'ImageInlineReq'
        db.create_table(u'services_imageinlinereq', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100)),
            ('requisite', self.gf('django.db.models.fields.related.ForeignKey')(related_name='images', max_length=255, to=orm['services.Requisite'])),
            ('sort', self.gf('django.db.models.fields.IntegerField')(default=100)),
        ))
        db.send_create_signal(u'services', ['ImageInlineReq'])


    def backwards(self, orm):
        # Deleting model 'Requisite'
        db.delete_table(u'services_requisite')

        # Removing M2M table for field color on 'Requisite'
        db.delete_table('services_requisite_color')

        # Deleting model 'ImageInlineReq'
        db.delete_table(u'services_imageinlinereq')
