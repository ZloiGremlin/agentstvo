...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Service.page'
        raise RuntimeError("Cannot reverse this migration. 'Service.page' and its values cannot be restored.")
