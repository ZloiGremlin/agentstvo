...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ImageInline.color'
        db.alter_column(u'services_imageinline', 'color_id', self.gf('django.db.models.fields.related.ForeignKey')(max_length=255, to=orm['services.Color'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ImageInline.color'
        raise RuntimeError("Cannot reverse this migration. 'ImageInline.color' and its values cannot be restored.")
